...
This repo contains several improvements for [JUnit](https://junit.org/junit5/) that allow you to take better advantage of JUnit 5/6 (jupiter engine) whenever using it together with [Xray Test Management](https://getxray.app).
...
You may find me on [Twitter](https://twitter.com/darktelecom) or on [Bluesky](https://bsky.app/profile/darktelecom.bsky.social).
