...
6. Does this support both JUnit5 and JUnit6?
For JUnit5 you can use versions until 0.12.0 From version 1.0.0 onwards, this project is compatible with JUnit 6 only.
Note that versions 0.12.0 provides the same features as version 1.0.0, even though the former is inly compatible with JUnit 5 and the later only with JUnit 6.
