...
class XrayReportData {
	...
	XrayReportData(TestPlan testPlan, Clock clock) {
	...
	public void setExecutionsStartedAt(long executionsStartedAt) {
		this.executionsStartedAt = executionsStartedAt;
	}

	public long getExecutionsStartedAt() {
		return this.executionsStartedAt;
	}
	
	public void setExecutionsFinishedAt(long executionsFinishedAt) {
		this.executionsFinishedAt = executionsFinishedAt;
	}

	public long getExecutionsFinishedAt() {
		return this.executionsFinishedAt;
	}
